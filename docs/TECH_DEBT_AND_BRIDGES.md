...
- The patch path is literal text replacement only. This keeps edits explainable and easy to revalidate.
...
- A structured multi-file patch format with before/after previews and exact apply receipts.
