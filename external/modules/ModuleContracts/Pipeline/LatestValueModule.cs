...
/// <summary>
/// Event-driven one-in-flight module worker. It consumes from one independent
/// subscription slot, publishes to independent subscriber slots, and never
/// executes downstream code or waits for downstream capacity.
/// </summary>
public abstract class LatestValueModule<TInput, TOutput> :
	IVisionModule,
