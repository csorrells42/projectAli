...
internal static class CodingPlannerInstructions
{
    public static string Build(IReadOnlyList<ChatMessage> history)
    {
        var lines = new List<string>
        {
            ...
            "- Explicit starter/template/scaffold requests: use build this for me <goal>; the model-authored patch lane should design the app dynamically from the requested behavior and available project context.",
