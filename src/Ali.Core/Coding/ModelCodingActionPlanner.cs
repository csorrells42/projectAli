...
public sealed class ModelCodingActionPlanner(ILocalModelRuntime runtime) : ICodingActionPlanner
{
    ...
    private static string BuildPlannerInstruction(IReadOnlyList<ChatMessage> history)
    {
        var lines = new List<string>
        {
            ...
            "- Console/WPF design help: console app guide <goal> or wpf app guide <goal>. For actual creation or edits, still use build this for me <goal>.",
            ...
            "- Data structures/services: for collections, algorithms, caches, queues, APIs, databases, SQL Server/PostgreSQL/MySQL/SQLite, or fast SQL design, prefer data systems guide <goal>, architecture/options, feature implementation planner, package lookup, dependency install packet, and validation chain before editing.",
