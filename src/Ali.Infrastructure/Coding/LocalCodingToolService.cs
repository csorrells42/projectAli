    ...
    string? pdfWorkspaceRoot = null) : ILocalCodingTool
{
    ...
    private CodingToolResult ShowComputerTroubleshootingCommandIndex()
    {
        var lines = new List<string>
        {
            ...
            "1. show computer troubleshooting commands",
            "2. plan slow computer troubleshooting",
            "3. plan network troubleshooting",
            "4. plan wifi troubleshooting",
            "5. plan printer troubleshooting",
            "6. plan audio troubleshooting",
            "7. plan microphone troubleshooting",
            "8. plan camera troubleshooting",
            "9. plan bluetooth troubleshooting",
            "10. plan usb device troubleshooting",
            "11. plan display troubleshooting",
            "12. plan windows update troubleshooting",
            "13. plan app crash troubleshooting",
            "14. plan startup cleanup",
            "15. plan browser troubleshooting",
            "16. plan onedrive sync troubleshooting",
            "17. plan backup strategy",
            "18. plan driver troubleshooting",
            "19. plan suspicious activity check",
            "20. plan remote support handoff",
            "Rules:",
            "- These are read-only planning commands.",
            "- Any fix that changes files, installs software, changes drivers, edits services/startup, clears browser data, changes network settings, or stops processes needs a narrower confirmed command.",
            "- If Ali cannot identify the cause from evidence, she should list options and ask for the next approved diagnostic step."
        };

        return new CodingToolResult(true, true, string.Join(Environment.NewLine, lines), "Computer troubleshooting command index", Policy.WorkspaceRoot);
    }
    ...
    private CodingToolResult PlanComputerTroubleshooting(CodingToolRequest request)
    {
        ...
        lines.AddRange(BuildComputerScenarioChecklist(scenario));
    ...
    private static IEnumerable<string> BuildComputerScenarioChecklist(string scenario)
    {
