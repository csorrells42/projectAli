...
public static class McpServerToolCatalog
{
    ...
    [
        ...
        Policy(AliCapabilityCatalog.VisualStudioInspectName, "Inspect installed Visual Studio capabilities."),
        ...
        Policy(AliCapabilityCatalog.VisualStudioOpenName, "Open an approved project in Visual Studio.", readsPrivateData: true),
        Policy(AliCapabilityCatalog.GnuNativeInspectName, "Inspect the installed GNU native toolchain."),
        Policy(AliCapabilityCatalog.GnuNativeExecuteName, "Analyze, build, test, or run C/C++ with GCC.", writesLocalData: true, readsPrivateData: true),
