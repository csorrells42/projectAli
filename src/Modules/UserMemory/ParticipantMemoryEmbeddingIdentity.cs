...
internal readonly record struct ParticipantMemoryEmbeddingPromptIdentity(
    string Mode,
    string Prefix)
{
    internal static ParticipantMemoryEmbeddingPromptIdentity From(EmbeddingPromptMode mode) => mode switch
    {
        EmbeddingPromptMode.Plain => new("none-v1", string.Empty),
        EmbeddingPromptMode.SearchDocument => new("prefix-v1", "search_document: "),
        EmbeddingPromptMode.SearchQuery => new("prefix-v1", "search_query: "),
    ...
    IParticipantMemoryEmbeddingIdentitySource
{
    public ParticipantMemoryEmbeddingIdentity Resolve(LocalVectorLibrarySettings settings)
    {
        ...
        var queryPrompt = ParticipantMemoryEmbeddingPromptIdentity.From(configuration.QueryPromptMode);
        var documentPrompt = ParticipantMemoryEmbeddingPromptIdentity.From(configuration.DocumentPromptMode);
