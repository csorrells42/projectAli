...
public sealed class CodingWorkspacePolicy
{
    ...
    public CodingToolPermission Evaluate(CodingToolRequest request)
    {
        ...
        if (request.Action is CodingToolAction.ShowProjectIntelligence
            or CodingToolAction.ShowProjectIndex
            or CodingToolAction.ShowProjectDependencyMap)
        {
        ...
        if (request.Action is CodingToolAction.ShowRepoUnderstanding
            or CodingToolAction.ShowCodingContextPacket
            ...
            or CodingToolAction.ShowDataStructureChooser
            or CodingToolAction.ShowSqlPerformanceGuide
            or CodingToolAction.ShowServiceArchitectureGuide
