...
static async Task TestLocalCodingToolSynthesizesWpfCounterStarter()
{
    ...
    await AssertWpfStarterAsync(
        ...
        ["ResourceDictionary Source=\"AliDashboardStyles.xaml\"", "BooleanToVisibilityConverter", "Window.InputBindings", "KeyBinding Key=\"F5\"", "KeyBinding Key=\"Escape\"", "DashboardDetailTemplate", "DashboardDetailCard", "ContentControl", "SelectedItem=\"{Binding SelectedItem, Mode=TwoWay}\"", "DashboardHeaderCardStyle", "NavigationTreeView", "ItemsSource=\"{Binding NavigationItems}\"", "HierarchicalDataTemplate", "IsExpanded\" Value=\"{Binding IsExpanded, Mode=TwoWay}\"", "IsSelected\" Value=\"{Binding IsSelected, Mode=TwoWay}\"", "SelectedNavigationSummary", "SelectedIndex=\"{Binding SelectedViewIndex, Mode=TwoWay}\"", "Text=\"{Binding SearchText, UpdateSourceTrigger=PropertyChanged}\"", "ItemsSource=\"{Binding ItemsView}\"", "DataGrid.GroupStyle", "GroupStyle.HeaderTemplate", "ProgressBar", "IsIndeterminate=\"{Binding IsBusy}\"", "Command=\"{Binding CancelRefreshCommand}\"", "ValidatesOnNotifyDataErrors=True", "DashboardInputTextBoxStyle", "NewItemError", "GridSplitter", "StatusBar", "TabControl", "Command=\"{Binding AddItemCommand}\""],
        ["DataContext = new MainWindowViewModel();"],
        "MainWindowViewModel.cs",
        ["INotifyPropertyChanged", "INotifyDataErrorInfo", "ObservableCollection<DashboardItem>", "ICollectionView ItemsView", "CollectionViewSource.GetDefaultView", "NavigationItems", "DashboardNavigationItem", "SelectedNavigation", "SelectedNavigationSummary", "SelectedViewIndex", "SeedNavigation", "SelectNavigationItem", "FindNavigationItemByViewIndex", "ConfigureItemsView", "SortDescriptions", "PropertyGroupDescription", "SearchText", "FilterItem", "FirstVisibleItem", "ICommand RefreshCommand", "CancelRefreshCommand", "IsBusy", "ProgressText", "CancellationTokenSource", "RefreshAsync", "Task.Delay", "NewItemError", "ErrorsChanged", "GetErrors", "ValidateNewItemName", "SetErrors", "DashboardItem? SelectedItem", "AsyncRelayCommand", "RelayCommand", "CanExecuteChanged"]);
