...
static Task TestProgrammingDashboardExposesCockpitCommands()
{
    ...
    Equal(true, visibleButtonCount <= 30);
    ...
    Contains("Project Target", dashboard);
    Contains("CodingCurrentSolutionOrProjectPathText", dashboard);
    Contains("CodingWorkspaceRootText", dashboard);
    Contains("Choose File", dashboard);
    Contains("Save Path", dashboard);
    Contains("Choose Folder", dashboard);
    Contains("New Project", dashboard);
    Contains("BrowseCodingCurrentSolutionOrProjectCommand", dashboard);
    Contains("BrowseCodingWorkspaceRootCommand", dashboard);
    Contains("SaveCodingPermissionsCommand", dashboard);
    ...
    Contains("Next Action", dashboard);
    Contains("Mini-Codex", dashboard);
    Contains("Project Center", dashboard);
    Contains("Project Memory", dashboard);
    Contains("Workspace", dashboard);
    Contains("Project Index", dashboard);
    Contains("Open Folder", dashboard);
    Contains("Build Loop", dashboard);
    Contains("Build Current", dashboard);
    Contains("Test Current", dashboard);
    Contains("Run Current", dashboard);
    Contains("Last Failure", dashboard);
    Contains("Safe Commit", dashboard);
    Contains("Patch And Handoff", dashboard);
    Contains("Exact Patch", dashboard);
    Contains("Patch Preview", dashboard);
    Contains("Apply Preview", dashboard);
    Contains("Validation Queue", dashboard);
    Contains("Receipts", dashboard);
    Contains("Latest Programming Result", dashboard);
    ...
    Contains("RunCodingMiniCodexStatusCommand", dashboard);
    Contains("Project Center", dashboard);
    Contains("RunCodingProjectControlCenterCommand", dashboard);
    Contains("RunCodingProjectMemoryCommand", dashboard);
    Contains("RunCodingWorkspaceDiagnosticCommand", dashboard);
    Contains("RunCodingProjectIndexCommand", dashboard);
    ...
    Contains("SaveCodingPermissionsCommand", viewModel);
    Contains("BrowseCodingWorkspaceRootCommand = CreateCommand", viewModel);
    ...
    Contains("CodingWorkspaceRootText", viewModel);
