...
static async Task TestLocalCodingToolSynthesizesWpfCounterStarter()
{
    ...
    await AssertWpfStarterAsync(
        ...
        ["ResourceDictionary Source=\"AliDashboardStyles.xaml\"", "BooleanToVisibilityConverter", "DashboardStatusBrushConverter", "Window.InputBindings", "KeyBinding Key=\"F5\"", "KeyBinding Key=\"Escape\"", "DashboardDetailTemplate", "DashboardDetailCard", "DataType=\"{x:Type local:OverviewDashboardViewModel}\"", "DataType=\"{x:Type local:ActivityDashboardViewModel}\"", "DataType=\"{x:Type local:SettingsDashboardViewModel}\"", "Content=\"{Binding SelectedWorkspaceView}\"", "ContentControl", "SelectedItem=\"{Binding SelectedItem, Mode=TwoWay}\"", "DashboardHeaderCardStyle", "NavigationTreeView", "ItemsSource=\"{Binding NavigationItems}\"", "HierarchicalDataTemplate", "IsExpanded\" Value=\"{Binding IsExpanded, Mode=TwoWay}\"", "IsSelected\" Value=\"{Binding IsSelected, Mode=TwoWay}\"", "SelectedNavigationSummary", "ItemsSource=\"{Binding Metrics}\"", "ItemsControl.ItemsPanel", "ItemsPanelTemplate", "UniformGrid Columns=\"3\"", "DashboardMetricCardStyle", "Text=\"{Binding SearchText, UpdateSourceTrigger=PropertyChanged}\"", "ItemsSource=\"{Binding ItemsView}\"", "DataGrid.GroupStyle", "GroupStyle.HeaderTemplate", "DataGridTemplateColumn", "DataGridTemplateColumn.CellTemplate", "Binding Path=\"Status\" Converter=\"{StaticResource DashboardStatusBrushConverter}\"", "CornerRadius=\"8\"", "ProgressBar", "IsIndeterminate=\"{Binding IsBusy}\"", "Command=\"{Binding CancelRefreshCommand}\"", "Command=\"{Binding RemoveSelectedItemCommand}\"", "ValidatesOnNotifyDataErrors=True", "DashboardFormLabelStyle", "DashboardInputTextBoxStyle", "DashboardInputComboBoxStyle", "SelectedItemName", "SelectedItemOwner", "SelectedItemStatus", "ItemsSource=\"{Binding StatusOptions}\"", "ItemsSource=\"{Binding ValidationSummary}\"", "Command=\"{Binding ApplySelectedItemCommand}\"", "NewItemError", "GridSplitter", "StatusBar", "Command=\"{Binding AddItemCommand}\""],
        ["DataContext = new MainWindowViewModel(new DashboardDialogService(this));", "DashboardDialogService", "IDashboardDialogService", "MessageBox.Show"],
        "MainWindowViewModel.cs",
        ["INotifyPropertyChanged", "INotifyDataErrorInfo", "IDashboardDialogService", "DashboardDialogRequest", "NullDashboardDialogService", "DashboardStatusBrushConverter", "IValueConverter", "CultureInfo", "Brushes.SeaGreen", "Binding.DoNothing", "ObservableCollection<DashboardItem>", "ObservableCollection<DashboardMetric>", "DashboardMetric", "UpdateMetrics", "CountVisibleItems", "CountItemsByStatus", "ObservableCollection<string> StatusOptions", "ObservableCollection<string> ValidationSummary", "ICollectionView ItemsView", "CollectionViewSource.GetDefaultView", "NavigationItems", "DashboardNavigationItem", "SelectedNavigation", "SelectedNavigationSummary", "SelectedWorkspaceView", "SelectedViewIndex", "OverviewView", "ActivityView", "SettingsView", "OverviewDashboardViewModel", "ActivityDashboardViewModel", "SettingsDashboardViewModel", "SeedNavigation", "SelectNavigationItem", "FindNavigationItemByViewIndex", "ConfigureItemsView", "SortDescriptions", "PropertyGroupDescription", "SearchText", "FilterItem", "FirstVisibleItem", "ICommand RefreshCommand", "CancelRefreshCommand", "ApplySelectedItemCommand", "CanApplySelectedItem", "ApplySelectedItem", "LoadSelectedItemEditor", "ValidateSelectedItemEditor", "SelectedItemName", "SelectedItemOwner", "SelectedItemStatus", "SelectedItemError", "RemoveSelectedItemCommand", "CanRemoveSelectedItem", "RemoveSelectedItem", "_dialogService.Confirm", "IsBusy", "ProgressText", "CancellationTokenSource", "RefreshAsync", "Task.Delay", "NewItemError", "ErrorsChanged", "GetErrors", "ValidateNewItemName", "SetErrors", "DashboardItem? SelectedItem", "AsyncRelayCommand", "RelayCommand", "CanExecuteChanged"]);
