...
foreach ($required in @('Ali.exe', 'Ali.dll', 'LICENSE', 'THIRD-PARTY-NOTICES.md', 'runtime-assets.json', 'THIRD-PARTY-RUNTIME-ASSETS.json', 'coding-toolchains.json', 'tools\RestoreCodingToolchains.ps1', 'editor-integrations.json', 'tools\ConfigureEditorIntegrations.ps1', 'docs\EDITOR-INTEGRATIONS.md', 'docs\AgentFrameworkArchitecture.md', 'skills\software-engineering\SKILL.md', 'skills\evidence-research\SKILL.md', 'skills\office-artifacts\SKILL.md', 'skills\engineering-shop-floor\SKILL.md')) {
